...
func EditEvent(w http.ResponseWriter, r *http.Request, ps httprouter.Params) {
	...
	go mq.Emit("event-updated", mq.Index{EntityType: "event", EntityId: eventID, Method: "PUT"})
...
// 	// Banner image
// 	bannerName, err := processBannerUpload(r, eventID)
// 	if err != nil {
// 		http.Error(w, "Banner upload failed: "+err.Error(), http.StatusBadRequest)
// 		return
// 	}
// 	if bannerName != "" {
// 		// event.BannerImage = bannerName
// 		updateFields["banner_image"] = bannerName
// 	}

// 	// Seating plan image
// 	seatingName, err := processSeatingPlanUpload(r, eventID)
// 	if err != nil {
// 		http.Error(w, "Seating plan upload failed: "+err.Error(), http.StatusBadRequest)
// 		return
// 	}
// 	if seatingName != "" {
// 		// event.SeatingPlanImage = seatingName
// 		updateFields["seatingplan"] = seatingName
// 	}
...
// func processBannerUpload(r *http.Request, eventID string) (string, error) {
// 	fileName, err := filemgr.SaveFormFile(r, "event-banner", filepath.Join(eventpicUploadPath, "banner"), false)
// 	if err != nil || fileName == "" {
// 		return "", nil // skip if not present
// 	}
// 	utils.CreateThumb(eventID, filepath.Join(eventpicUploadPath, "banner"), ".jpg", 300, 200)
// 	return fileName, nil
// }

// func processSeatingPlanUpload(r *http.Request, eventID string) (string, error) {
// 	_ = eventID
// 	fileName, err := filemgr.SaveFormFile(r, "event-seating", filepath.Join(eventpicUploadPath, "seating"), false)
// 	if err != nil || fileName == "" {
// 		return "", nil
// 	}
// 	return fileName, nil
